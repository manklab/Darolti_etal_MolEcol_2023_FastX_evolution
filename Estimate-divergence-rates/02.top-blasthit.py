...
This script takes the output blast files of a reciprocal blast. 
...
If multiple sequences have the same bitscore and pidentity, the ortholog is discarded.
...
def find_pairs_ensembl(infiles):
    ...
    for a, b in combinations(infiles, 2):
        ...
        a_query = abase[2].split("_")[0]
        b_db = bbase[0].split("_")[0]
        b_query = bbase[2].split("_")[0]
