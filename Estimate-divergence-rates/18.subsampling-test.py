...
def main():
    ...
    with open(args.larger_dataset, 'r') as larger:
        with open(args.smaller_dataset, 'r') as smaller:
            ...
            # Get mean dN, dS and dNdS for the larger and smaller files
            list_N_larger = []
            list_S_larger = []
            list_NdN_larger = []
            list_SdS_larger = []
            for line in genelist_larger:
                ...
                list_SdS_larger.append(float(line.split(",")[8]))
                list_NdN_larger.append(float(line.split(",")[7]))
            ...
            print "check dN_larger, dS_larger, dNdS_larger = ", dN_larger, dS_larger, dNdS_larger 
            ...
            for line in genelist_smaller:
                ...
                list_SdS_smaller.append(float(line.split(",")[8]))
                list_NdN_smaller.append(float(line.split(",")[7]))
            ...
            print "check dN_smaller, dS_smaller, dNdS_smaller = ", dN_smaller, dS_smaller, dNdS_smaller 
            ...
            while i < 1000:
                ...
                for line in smaller_list_rand:
                    ...
                    list_SdS.append(float(line.split(",")[8]))
                    list_NdN.append(float(line.split(",")[7]))
