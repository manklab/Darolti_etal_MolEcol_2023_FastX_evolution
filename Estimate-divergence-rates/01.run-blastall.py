...
'''This script performs a reciprocal best-hit blast analysis.
A list of input genomes is blasted against each other and the output is written in provided format. Name of outfile is db name.query name.bla.
...
parser.add_argument("-o", "--outdir", type=str, default="./",
                    help="The output directory for the blastout files [default ./]")
...
parser.add_argument("-id", "--identity", type=int, default=30,
                    help="min. percent identity [default: 30]")
